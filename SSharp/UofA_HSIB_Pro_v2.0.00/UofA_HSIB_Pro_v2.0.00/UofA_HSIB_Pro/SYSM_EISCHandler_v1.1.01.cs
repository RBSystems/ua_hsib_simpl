...
namespace UofA_HSIB_Pro
{
    ...
    public class SYSM_EISCHandler
    {
         ...
         * v1.1.00: Uses SYSM_ConfigurationHandler_v1.2.00
         *              Downwind class uses a pacer now
         * v1.1.01: Adding a block for [EISCConnectBlockInMs] when an EISC connects              
         * */
        public const string CLASSID = "EISC";

        public const string PRO3IP1 = "10.156.32.100";
        ...
        public int PacerTimeinMs = 5000;
        public bool EnablePacer;
        ...
        public void EISC_SigChange(BasicTriList currentDevice, SigEventArgs args)
        {
            ...
            {                
                ...
                CrestronConsole.PrintLine("********** IgnoreEISCSignals high, type is {0}", args.Sig.Type);
            }
            ...
            else if (args.Sig.Type == eSigType.String)
            {
                if (args.Sig.StringValue.Length != 0)
                {
                    if (args.Sig.Number == 700)
                    {
                        ...
                        controlSystem.ConfigurationHandler.Pacer.AddToList(ConfigPacer.Method.ConfigureMatrix, args);
                    }
                    else if (args.Sig.Number >= 1 && args.Sig.Number <= 699)
                    {
                        //controlSystem.ConfigurationHandler.ConfigureMatrixOutput(args);
                        controlSystem.ConfigurationHandler.Pacer.AddToList(ConfigPacer.Method.ConfigureMatrixOutput, args);
                    }
                    else if (args.Sig.Number >= 701 && args.Sig.Number <= 1399)
                    {
                        //controlSystem.ConfigurationHandler.ConfigureMatrixInput(args);
                        controlSystem.ConfigurationHandler.Pacer.AddToList(ConfigPacer.Method.ConfigureMatrixInput, args);
                    }
                }
                else
                {
        ...
        private object parseDSPSignal(object _args)
        {
            ...
            else if (args.Sig.Type == eSigType.String)
            {
                if (args.Sig.Number == 500)
                {
                    ...
                    controlSystem.ConfigurationHandler.Pacer.AddToList(ConfigPacer.Method.ConfigureDSP, args);
                }
                else if (args.Sig.Number >= 1 && args.Sig.Number <= 499)
                {
                    //controlSystem.ConfigurationHandler.ConfigureDSPSignal(args);
                    controlSystem.ConfigurationHandler.Pacer.AddToList(ConfigPacer.Method.ConfigureDSPSignal, args);
                }
            }
            return null;
        }
        ...
        private object parseDPLYorCAMSignal(object _args)
        {
            ...
            else if (args.Sig.Type == eSigType.String)
            {
                ...
                if (args.Sig.Number >= 1 && args.Sig.Number <= 199)
                {
                    ...
                    controlSystem.ConfigurationHandler.Pacer.AddToList(ConfigPacer.Method.ConfigureDisplay, args);
                }
                else if (args.Sig.Number >= 1301 && args.Sig.Number <= 1349)
                {
                    //controlSystem.ConfigurationHandler.ConfigureCamera(args);
                    controlSystem.ConfigurationHandler.Pacer.AddToList(ConfigPacer.Method.ConfigureCamera, args);
                }
        ...
        private object parseIMGPorRLYorLGHTSignal(object _args)
        {
            ...
            else if (args.Sig.Type == eSigType.String)
            {
                ...
                if (args.Sig.Number >= 101 && args.Sig.Number <= 199)
                {
                    ...
                    controlSystem.ConfigurationHandler.Pacer.AddToList(ConfigPacer.Method.ConfigureRelay, args);
                }
                else if (args.Sig.Number >= 1001 && args.Sig.Number <= 1049)
                {
                    //controlSystem.ConfigurationHandler.ConfigureLightID(args);
                    controlSystem.ConfigurationHandler.Pacer.AddToList(ConfigPacer.Method.ConfigureLightID, args);
                }
                else if (args.Sig.Number >= 1101 && args.Sig.Number <= 1109)
                {
                    //controlSystem.ConfigurationHandler.ConfigureLight(args);
                    controlSystem.ConfigurationHandler.Pacer.AddToList(ConfigPacer.Method.ConfigureLight, args);
                }
            }
            return null;
        }
