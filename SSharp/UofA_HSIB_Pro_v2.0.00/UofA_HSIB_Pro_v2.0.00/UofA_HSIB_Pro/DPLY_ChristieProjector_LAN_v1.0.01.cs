...
namespace PWCSharpPro
{
    ...
    {
        /* Changelog:
         * v1.0.01: Added OnFeedbackUdate() to valid power feedback
         *          Added polling after a power command
         *          Added polling when in cooling or warming
         *          Only resets pollTimer if it's initialised
         * */
