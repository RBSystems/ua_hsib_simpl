    ...
    public class SYSM_ConfigurationHandler
    {
        ...
        public void ConfigureMatrixInput(SigEventArgs args)
        {
            try
            {
                ...
                controlSystem.mtrxSignals.AddInput((int)args.Sig.Number % 700, Int32.Parse(args.Sig.StringValue.Split('|')[1]), args.Sig.StringValue.Split('|')[0]);
        ...
        public void ConfigureCamera(SigEventArgs args)
        {
            try
            {
                ...
                controlSystem.camSonyClients[id].EnableUDPServer();
