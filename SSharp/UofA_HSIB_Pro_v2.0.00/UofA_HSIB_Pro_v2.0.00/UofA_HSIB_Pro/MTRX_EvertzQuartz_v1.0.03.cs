...
namespace PWCSharpPro
{
    public class MTRX_EvertzQuartz : MTRX
    {
        ...
        // Block of vars used to pace the commands to Evertz. Sending commands as fast as possible stops the Evertz from working
        public bool PacingBlock = false;
        private int TimeBetweenCommandsInMs = 100;
