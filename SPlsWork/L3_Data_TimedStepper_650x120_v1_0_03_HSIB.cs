...
namespace UserModule_L3_DATA_TIMEDSTEPPER_650X120_V1_0_03_HSIB
{
    public class UserModuleClass_L3_DATA_TIMEDSTEPPER_650X120_V1_0_03_HSIB : SplusObject
    {
    ...
    private void FCLEARDATA (  SplusExecutionContext __context__ ) 
        ...
        ushort __FN_FORSTART_VAL__1 = (ushort) ( 1 ) ;
        ushort __FN_FOREND_VAL__1 = (ushort)650; 
        int __FN_FORSTEP_VAL__1 = (int)1; 
        for ( I  = __FN_FORSTART_VAL__1; (__FN_FORSTEP_VAL__1 > 0)  ? ( (I  >= __FN_FORSTART_VAL__1) && (I  <= __FN_FOREND_VAL__1) ) : ( (I  <= __FN_FORSTART_VAL__1) && (I  >= __FN_FOREND_VAL__1) ) ; I  += (ushort)__FN_FORSTEP_VAL__1) 
            { 
...
public override void LogosSplusInitialize()
{
    ...
    _SplusNVRAM.ICHANGED  = new ushort[ 651 ];
...
public UserModuleClass_L3_DATA_TIMEDSTEPPER_650X120_V1_0_03_HSIB ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
