...
namespace UserModule_L3_SMART_LIST_FB60_V1_0_07
{
    public class UserModuleClass_L3_SMART_LIST_FB60_V1_0_07 : SplusObject
    {
        ...
        ushort INOHTML = 0;
        ushort ICOLUMNS = 0;
        ushort IPROCESSSEM = 0;
        ushort [] IVIS;
        ushort [] IFB;
        CrestronString STRASH;
        CrestronString SDATABUFFER;
        ...
        object RX__DOLLAR___OnChange_0 ( Object __EventInfo__ )
            ...
            try
            {
                ...
                while ( Functions.TestForTrue  ( ( Functions.ReverseFind( "}" , RX__DOLLAR__ ))  ) ) 
                    { 
    ...
    public UserModuleClass_L3_SMART_LIST_FB60_V1_0_07 ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
    ...
    const uint FB__DigitalOutput__ = 60;
