...
namespace UserModule_L3_UA_HSIB_NODEMST_V1_0_80
{
    public class UserModuleClass_L3_UA_HSIB_NODEMST_V1_0_80 : SplusObject
    {
            ...
            __context__.SourceCodeLine = 1012;
                ...
                int __SPLS_TMPVAR__SWTCH_9__ = ((int)ILIST);
                    ...
                    if  ( Functions.TestForTrue  (  ( __SPLS_TMPVAR__SWTCH_9__ == ( 1) ) ) ) 
                        ...
                        CreateWait ( "__SPLS_TMPVAR__WAITLABEL_214__" , 1000 , __SPLS_TMPVAR__WAITLABEL_214___Callback ) ;
                        } 
        ...
        public void __SPLS_TMPVAR__WAITLABEL_214___CallbackFn( object stateInfo )
        {
    ...
    private void FPROCESSLINE (  SplusExecutionContext __context__, ushort IROOM , ushort ILIST , ushort IINDEX , CrestronString STEMP ) 
        ...
        if ( Functions.TestForTrue  ( ( ROOM[ IROOM ].LIST[ ILIST ].ITEM[ IINDEX ].IISCAMERA)  ) ) 
            ...
            Trace( "Room[{0:d}].Cam[{1:d}].iCamGUID={2:d}", (ushort)IROOM, (ushort)ICAM, (ushort)ROOM[ IROOM ].CAM[ ICAM ].ICAMGUID) ; 
            __context__.SourceCodeLine = 1346;
            Trace( "Room[{0:d}].Cam[{1:d}].iVSrcLocalID={2:d}", (ushort)IROOM, (ushort)ICAM, (ushort)ROOM[ IROOM ].CAM[ ICAM ].IVSRCLOCALID) ; 
            __context__.SourceCodeLine = 1347;
            Trace( "Room[{0:d}].Cam[{1:d}].iVSrcGUID={2:d}", (ushort)IROOM, (ushort)ICAM, (ushort)ROOM[ IROOM ].CAM[ ICAM ].IVSRCGUID) ; 
            ...
            if ( Functions.TestForTrue  ( ( SYS.IISRCPAIR)  ) ) 
                ...
                Trace( "Room[{0:d}].Cam[{1:d}].iCamGUID={2:d}", (ushort)FOTHERROOM( __context__ , (ushort)( IROOM ) ), (ushort)(ICAM + 3), (ushort)ROOM[ FOTHERROOM( __context__ , (ushort)( IROOM ) ) ].CAM[ (ICAM + 3) ].ICAMGUID) ; 
                __context__.SourceCodeLine = 1365;
                Trace( "Room[{0:d}].Cam[{1:d}].iVSrcLocalID={2:d}", (ushort)FOTHERROOM( __context__ , (ushort)( IROOM ) ), (ushort)(ICAM + 3), (ushort)ROOM[ FOTHERROOM( __context__ , (ushort)( IROOM ) ) ].CAM[ (ICAM + 3) ].IVSRCLOCALID) ; 
                __context__.SourceCodeLine = 1366;
                Trace( "Room[{0:d}].Cam[{1:d}].iVSrcGUID={2:d}", (ushort)FOTHERROOM( __context__ , (ushort)( IROOM ) ), (ushort)(ICAM + 3), (ushort)ROOM[ FOTHERROOM( __context__ , (ushort)( IROOM ) ) ].CAM[ (ICAM + 3) ].IVSRCGUID) ; 
                } 
...
public override void LogosSplusInitialize()
{
    ...
    __SPLS_TMPVAR__WAITLABEL_214___Callback = new WaitFunction( __SPLS_TMPVAR__WAITLABEL_214___CallbackFn );
...
private WaitFunction __SPLS_TMPVAR__WAITLABEL_214___Callback;
