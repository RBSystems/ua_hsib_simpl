...
namespace UserModule_TOGGLE2_
{
    public class UserModuleClass_TOGGLE2_ : SplusObject
    {
        ...
        InOutArray<Crestron.Logos.SplusObjects.DigitalInput> BSET;
        InOutArray<Crestron.Logos.SplusObjects.DigitalInput> BRESET;
        ...
        ushort S = 0;
        ushort T = 0;
        object BSET_OnPush_0 ( Object __EventInfo__ )
    ...
    object BRESET_OnPush_1 ( Object __EventInfo__ )
...
public override void LogosSplusInitialize()
{
    ...
    BSET = new InOutArray<DigitalInput>( 3, this );
    for( uint i = 0; i < 3; i++ )
    {
        BSET[i+1] = new Crestron.Logos.SplusObjects.DigitalInput( BSET__DigitalInput__ + i, BSET__DigitalInput__, this );
        m_DigitalInputList.Add( BSET__DigitalInput__ + i, BSET[i+1] );
    }
    
    BRESET = new InOutArray<DigitalInput>( 3, this );
    for( uint i = 0; i < 3; i++ )
    {
        BRESET[i+1] = new Crestron.Logos.SplusObjects.DigitalInput( BRESET__DigitalInput__ + i, BRESET__DigitalInput__, this );
        m_DigitalInputList.Add( BRESET__DigitalInput__ + i, BRESET[i+1] );
    }
    ...
    for( uint i = 0; i < 3; i++ )
        BSET[i+1].OnDigitalPush.Add( new InputChangeHandlerWrapper( BSET_OnPush_0, false ) );
        
    for( uint i = 0; i < 3; i++ )
        BRESET[i+1].OnDigitalPush.Add( new InputChangeHandlerWrapper( BRESET_OnPush_1, false ) );
...
const uint BSET__DigitalInput__ = 1;
const uint BRESET__DigitalInput__ = 4;
