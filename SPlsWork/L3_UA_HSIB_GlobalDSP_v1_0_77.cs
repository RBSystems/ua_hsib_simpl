...
namespace UserModule_L3_UA_HSIB_GLOBALDSP_V1_0_77
{
    public class UserModuleClass_L3_UA_HSIB_GLOBALDSP_V1_0_77 : SplusObject
    {
...
private void FPROCESSLINE (  SplusExecutionContext __context__, ushort ITYPE , ushort IINDEX , CrestronString STEMPLINEARG ) 
    ...
    if ( Functions.TestForTrue  ( ( Functions.Not( IERR ))  ) ) 
        ...
        if ( Functions.TestForTrue  ( ( Functions.BoolToInt ( (Functions.TestForTrue ( LIST[ IINDEX ].IRMASS ) && Functions.TestForTrue ( LIST[ IINDEX ].IPOINTTYPE )) ))  ) ) 
            ...
            MakeString ( LIST [ IINDEX] . SGLOBALNAME , "Rm{0:d} {1}", (ushort)ROOM[ LIST[ IINDEX ].IRMASS ].IROOMNUM, LIST [ IINDEX] . SLOCALNAME ) ; 
...
public UserModuleClass_L3_UA_HSIB_GLOBALDSP_V1_0_77 ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
