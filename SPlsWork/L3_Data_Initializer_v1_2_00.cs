    ...
    public class UserModuleClass_L3_DATA_INITIALIZER_V1_2_00 : SplusObject
    {
        ...
        private void FPROCESSLOCALDATA (  SplusExecutionContext __context__ ) 
            ...
            if ( Functions.TestForTrue  ( ( SEND_FINALIZE_DATA  .Value)  ) ) 
                ...
                CreateWait ( "__SPLS_TMPVAR__WAITLABEL_1__" , END_DELAY  .Value , __SPLS_TMPVAR__WAITLABEL_1___Callback ) ;
                } 
            
            __context__.SourceCodeLine = 341;
            CreateWait ( "__SPLS_TMPVAR__WAITLABEL_2__" , (END_DELAY  .Value * 2) , __SPLS_TMPVAR__WAITLABEL_2___Callback ) ;
...
private short FPROCESSFILEDATA (  SplusExecutionContext __context__ ) 
    ...
    if ( Functions.TestForTrue  ( ( SEND_FINALIZE_DATA  .Value)  ) ) 
        ...
        CreateWait ( "__SPLS_TMPVAR__WAITLABEL_3__" , END_DELAY  .Value , __SPLS_TMPVAR__WAITLABEL_3___Callback ) ;
        } 
    
    __context__.SourceCodeLine = 545;
    CreateWait ( "__SPLS_TMPVAR__WAITLABEL_4__" , END_DELAY  .Value , __SPLS_TMPVAR__WAITLABEL_4___Callback ) ;
