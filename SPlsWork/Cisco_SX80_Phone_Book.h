namespace Cisco_SX80_Phone_Book;
     ...
     class PhoneBookHelper 
    {
        ...
        delegate FUNCTION delegateMultipleMethods ( );
        delegate FUNCTION delegateDebugData ( SIMPLSHARPSTRING toSimplPlus );
        ...
        FUNCTION cisco_multipleMethods ();
        FUNCTION cisco_searchMultipleMethods ();
        FUNCTION cisco_debugData ( SIMPLSHARPSTRING simplString );
        ...
        SIMPLSHARPSTRING_FUNCTION getParent ();
        ...
        DelegateProperty delegateMultipleMethods multipleMethods;
        DelegateProperty delegateMultipleMethods searchMultipleMethods;
        DelegateProperty delegateDebugData debugData;
    };
